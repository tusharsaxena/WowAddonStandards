...
- **Switching tabs is a structural re-render** — the same path a change of subject takes — so it inherits options-ui-§2's combat refusal rather than declaring its own. A host **MUST NOT** write a second combat guard for it.

# New Ka0s Addon — Context Pack (v2.48.0, 2026-09-16)
...
18. Preview/test mode (preview-mode): addons with a positionable display MUST ship a test mode (placeholder data, on until turned off, session-only, ended by combat), switched by the Master controls `Test mode` checkbox (options-ui-§15); unlocking MAY also show the placeholders.

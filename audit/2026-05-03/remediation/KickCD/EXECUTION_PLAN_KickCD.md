...
**Standards:** `WowAddonStandards/standards/01_STANDARD.md`
...
**Checkpoint:** M10 complete — KickCD on `1.2.0`, fully standards-compliant per `WowAddonStandards/standards/01_STANDARD.md`.

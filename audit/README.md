...
| Date | Scope | Summary |
|---|---|---|
| [`2026-05-03/`](2026-05-03/) | 5 addons audited (AbsorbTracker, ConsumableMaster, KickCD, prettychat, WhatGroup); 10 reference addons researched | [`2026-05-03/00_EXECUTIVE_SUMMARY.md`](2026-05-03/00_EXECUTIVE_SUMMARY.md) |
...
audit/<YYYY-MM-DD>/
  ...
  03_INDUSTRY_RESEARCH.md    -- patterns from reference addons
  04_DEVIATIONS.md           -- per-addon gap report against the standard
  _raw/                      -- full per-addon evidence (_industry/ = reference-addon research)
...
2. Keep **deviation IDs** per-addon and stable (AT-\*, CM-\*, KCD-\*, PC-\*, WG-\*) — they are the
   shared key between `04_DEVIATIONS.md` and the remediation plans.

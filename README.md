...
New to this? Read [`standards/00_EXECUTIVE_SUMMARY.md`](standards/00_EXECUTIVE_SUMMARY.md) — the
one-page TL;DR of the standard. The canonical output is
[`standards/01_STANDARD.md`](standards/01_STANDARD.md) — **the standard**.
...
5. **Ripple the change.** Sync [`standards/00_EXECUTIVE_SUMMARY.md`](standards/00_EXECUTIVE_SUMMARY.md)
   and [`standards/02_NEW_ADDON_CONTEXT.md`](standards/02_NEW_ADDON_CONTEXT.md).
...
[`standards/02_NEW_ADDON_CONTEXT.md`](standards/02_NEW_ADDON_CONTEXT.md) pack into the addon's `docs/`,
...
Standard is at **v1.4.0** and living. Compliance auditing has moved out of this repo into each addon's
